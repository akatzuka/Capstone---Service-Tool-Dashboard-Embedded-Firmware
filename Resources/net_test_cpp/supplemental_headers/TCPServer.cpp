...
bool CTCPServer::Listen(size_t msec /*= ACCEPT_WAIT_INF_DELAY*/)
{
...
bool CTCPServer::Accept(ASocket::Socket& ClientSocket) {
 ...
 * ret < 0   : recv failed
 */
int CTCPServer::Recv(const CTCPServer::Socket ClientSocket,
                        char* pData,
                        const size_t uSize,
