...
IOS_Data dataToSend;
IOS_Data overrideDataStruct;

std::vector<unsigned char> firmwareUpdate;
...
static inline void storeStructToRAM() {
	*(din_ram) = overrideDataStruct.din;
	*(dout_ram) = overrideDataStruct.dout;
	*(ain_ram) = overrideDataStruct.ain;
